...
<li><a class="active" href="./reviews.html" target="_self" title="Reviews">Reviews</a>
</li>
<li><a href="./about_us.html" target="_self" title="About Us">About&nbsp;Us</a>
</li>
...
<input type="text" id="Editbox1" style="position:absolute;left:112px;top:147px;width:364px;height:29px;line-height:29px;z-index:7;" name="Name" value="" spellcheck="false" placeholder="Restaurant Name">
<input type="submit" id="Button1" name="" value="Submit" style="position:absolute;left:540px;top:154px;width:96px;height:25px;z-index:8;">
...
<script>
    function searchquery(){
        var resname = document.getElementById("Editbox1").value;
        //window.location.href='./index.html?name='+resname;
        window.location.href='./reviews_result.php?name='+resname;
         
        
    }
     document.getElementById("Button1").addEventListener("click", searchquery);
    
    
    <?php
   
        $query = "SELECT rest_info.rest_ID, rest_info.rest_Name, rest_info.rest_name_Location, rest_info.rest_loc_Lat, rest_info.rest_loc_Long, rest_info.rest_Contact, rest_info.rest_ParkingCapacity, rest_info.rest_SeatingCapacity, rest_info.rest_Photo FROM rest_info WHERE rest_Name LIKE '%$name%'";
...
<div id="Layer4" style="position:absolute;text-align:center;left:0px;top:845px;width:100%;height:55px;z-index:10;">
